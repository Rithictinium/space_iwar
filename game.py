...
class Game:
    def __init__(self, screen_width, screen_height, offset):
        ...
        self.score = 0
        self.highscore = 0
        self.mystery_ship_hits = 0  # Number of hits on the mystery ship
        self.game_status = None  # Game status: None, "win", or "game over"
        ...
        if self.spaceship_group.sprite.lasers_group:
            for laser_sprite in self.spaceship_group.sprite.lasers_group:
                ...
                if pygame.sprite.spritecollide(laser_sprite, self.mystery_ship_group, True):
                    ...
                    # Increment hits to the mystery ship
                    self.mystery_ship_hits += 1
                    if self.mystery_ship_hits == 3:  # Change to 3 hits for win
        ...
        if self.alien_lasers_group:
            for laser_sprite in self.alien_lasers_group:
                if pygame.sprite.spritecollide(laser_sprite, self.spaceship_group, False):
                    laser_sprite.kill()
                    self.lives -= 1
                    if self.lives == 0:  # Losing condition
